...
void CdvshostdemoDlg::fetchXmqHostServiceCapabilitiesNotification(const std::vector<std::string> services)
{
...
void CdvshostdemoDlg::fetchXmqHostClientReceivedDataNotification(const std::string data)
{
